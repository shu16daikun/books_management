...
urlpatterns = [
    ...
    path('reservation/<int:book_pk>/done/<int:pk>/<str:token>/', views.BookReservationDoneView.as_view(), name="book_reservation_done"),
    path('rent/<int:book_pk>/', views.BookRentView.as_view(), name="book_rent"),
    path('rent/<int:book_pk>/done/<int:pk>/<str:token>/', views.BookRentDoneView.as_view(), name="book_rent_done"),
    path('rent/list/', views.RentListView.as_view(), name='rent_list'),
    path('return/<int:pk>/', views.ReturnBookView.as_view(), name="return_book"),
    path('cancel/<int:pk>/', views.CancelReservationView.as_view(), name="cancel_reservation"),
    path('review/<int:pk>/<str:token>/', views.ReviewView.as_view(), name='review'),
    path('review/<int:pk>/done/<str:token>/', views.ReviewDoneView.as_view(), name="review_done"),
]