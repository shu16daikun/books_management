...
urlpatterns = [
    ...
    path('reservation/<int:book_pk>/done/<int:pk>/', views.BookReservationDoneView.as_view(), name="book_reservation_done"),
    path('rent/<int:book_pk>/', views.BookRentView.as_view(), name="book_rent"),
    path('rent/<int:book_pk>/done/<int:pk>/', views.BookRentDoneView.as_view(), name="book_rent_done"),
    ...
    path('review/<int:pk>/done/', views.ReviewDoneView.as_view(), name="review_done"),
]